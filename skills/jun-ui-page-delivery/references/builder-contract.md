...
`bundle-app` injects the shared `--jun-ui-*` token definitions into the bundled CSS. Target project CSS should only reference those tokens or local aliases derived from them; it should not define new page color literals.
